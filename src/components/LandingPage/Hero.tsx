      ...
      <div className="flex flex-col md:flex-row  md:items-center justify-center">
        <div className=" w-full md:w-[50%]">
          <div className="w-full flex flex-col">
            ...
            Seamlessly chat with individuals across language barriers. No more copy-pasting. Just real-time, in-chat translations.
            </p>
            <Button
              type="button"
          ...
          <p className="pt-2  text-center md:text-start  lg:text-[13px]">Talkcatoo has revolutionized how our team communicates. The real-time translation feature means 
            we can work seamlessly with international partners without missing a beat!
          </p>   
        ...
        <div className="mt-[4rem] z-[1] md:w-[50%] ">
          ...
          />
          <img src="assets/img/text1.png" alt="text-image" className=" h-auto mx-auto block md:hidden max-w-screen-md"/>
          <img src="assets/img/text2.png" alt="text-image" className=" h-auto mx-auto block md:hidden max-w-screen-md"/>
        </div>
      </div>
    </section>
  );
