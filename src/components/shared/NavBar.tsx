           ...
           py-2 px-2 rounded-[3px]  flex items-center justify-center flex-col
            ...
            <FaGlobe
               className={`${
                ...
                } ${isDarkMode ?  "text-white" : "text-[#25282C]" }  z-4 object-contain py-1 w-[29px] text-[32px]`}
            />
            {showLanguages && (
            <div ref={languageRef} className="overflow-hidden absolute z-50 bottom-[-170px] bg-white border-[1px] border-gray-200 rounded-lg shadow-blur flex flex-col items-center">          
            {/* map languages */}
