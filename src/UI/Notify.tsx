    ...
    <>
      {isVisible && (
        <div className='fixed top-0 left-0 w-full h-full flex bg-black bg-opacity-10 z-50 items-center justify-center'>
          <div className={`bg-white fixed w-[20%] shadow-blur shadow-black h-[20%] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-4 rounded-lg z-50 flex flex-col items-center justify-evenly max-sm:w-[90%]`}>
